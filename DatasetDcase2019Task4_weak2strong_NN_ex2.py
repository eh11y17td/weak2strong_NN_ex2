...
class DatasetDcase2019Task4_weak2strong_NN_ex2:
    ...
    def get_df_from_meta(meta_name, subpart_data=None):
        ...
        if subpart_data is not None:
            df = DatasetDcase2019Task4_weak2strong_NN_ex2.get_subpart_data(df, subpart_data)
        return df
    ...
    def download_from_meta(self, filename, subpart_data=None, n_jobs=3, chunk_size=10):
        ...
        df = DatasetDcase2019Task4_weak2strong_NN_ex2.get_df_from_meta(filename, subpart_data)
