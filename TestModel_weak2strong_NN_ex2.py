...
from evaluation_measures_weak2strong_NN_ex2 import audio_tagging_results, get_f_measure_by_class, compute_strong_metrics, get_predictions
...
def test_model(state, reference_tsv_path, reduced_number_of_data=None, strore_predicitions_fname=None):
    dataset = DatasetDcase2019Task4_weak2strong_NN_ex2(os.path.join(cfg.workspace),
